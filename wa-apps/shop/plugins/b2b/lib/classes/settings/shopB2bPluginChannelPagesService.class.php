...
class shopB2bPluginChannelPagesService extends shopB2bPluginChannelSettingsService
{
    protected shopB2bPluginChannelPageModel $page_model;

    public function __construct()
    {
        parent::__construct();
        $this->page_model = new shopB2bPluginChannelPageModel();
    }
