 ...
 * - путь к шаблону считается относительно wa-apps/shop/.
 *
 * Побочные эффекты:
 ...
 */
final class shopLkPluginFetchHtml
{
    /**
     * Возвращает результат рендеринга шаблона.
     *
     * Параметры:
     * - file   => путь к шаблону относительно wa-apps/shop/;
    ...
    public static function getHtml(array $params = []): string
    {
        ...
        $file = wa()->getAppPath($file_param, 'shop');
