...
final class shopLkPluginGetIcon
{
    ...
    public static function html(string $icon, array $params = []): string
    {
        ...
        if (strpos($icon, '<') === false && strpos($icon, 'lk-icon') !== false) {
    ...
    public static function svg(string $symbol_id, array $params = []): string
    {
        ...
        $static_url = wa('shop')->getAppStaticUrl('shop', false);
        ...
        $class_attr = trim('lk-icon svg ' . $class);
