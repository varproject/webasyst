 ...
 *
 * ПУБЛИЧНЫЙ API
 * - lk.select2.init([root]) — инициализация внутри контейнера root (по умолчанию document).
 *
 * ПРАВИЛА
...
; (function (lk, window, document, $) {
    ...
    var select2Module = lk.select2 = lk.select2 || {};
...
})(window.lk = window.lk || {}, window, document, window.jQuery);