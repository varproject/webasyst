    ...
    return (
        <Layout>
            <App>
                <Article
                    title="DataTables"
                    subtitle="DataTables is a table enhancing plug-in for the jQuery, adding sorting, paging and filtering abilities to plain HTML tables with minimal effort."
                    breadcrumb={[
                ...
                >
                    ...
                    <Example>
                        <div className="card">
                            <table className="sa-datatables-init" data-order={'[[ 0, "asc" ]]'}>
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
