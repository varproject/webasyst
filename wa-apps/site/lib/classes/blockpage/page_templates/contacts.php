<?php
return [
  // Без ключа 'data' будет использован базовый вариант блока,
  // как добавляется на страницу в редакторе, без изменений
  // (включая всех потомков)
  [ 'type' => 'site.MenuT1', ],

  [
    'type' => 'site.CustomContactsReverse',
    'data' => [
      'block_props' => [
        'site-block-columns' => [
          'padding-top' => 'p-t-18',
            ...
            '' => [
              [
                ...
                'data' => [
                  ...
                  'column' => 'st-4 st-5-lp st-6-tb st-12-mb',
                  'block_props' => [
                    'site-block-column' => [
                      ...
                      'children' => [
                        '' => [
                          ...
                          [
                            'type' => 'site.Heading',
                            'data' => [
                              'html' => '<font color="" class="tx-blc">+1 234 567 89 10</font>',
                              'tag' => 'h1',
                              'block_props' => [
                                'font-size' => [
                                  'name' => 'Size #5',
                          ...
                          [
                            'type' => 'site.Heading',
                            'data' => [
                              'html' => 'epistula@tabellario.romano',
                              'tag' => 'h1',
                              'block_props' => [
                                'font-size' => [
                                  'name' => 'Size #5',
                          ...
                          [
                            'type' => 'site.Heading',
                            'data' => [
                              'html' => '<font color="" class="tx-bw-3">Roma, Via Augusta, dom. 10, ins. 5.</font>',
                              'tag' => 'h1',
                              'block_props' => [
                                'font-size' => [
                                  'name' => 'Size #6',
                          ...
                          [
                            'type' => 'site.Heading',
                            'data' => [
                              'html' => '<font color="" class="tx-bw-3">Marcus Cornelius Felix</font>',
                              'tag' => 'h1',
                              'block_props' => [
                                'font-size' => [
                                  'name' => 'Size #6',
              ...
              [
                ...
                'data' => [
                  ...
                  'column' => 'st-8 st-7-lp st-6-tb st-12-mb',
                  'block_props' => [
                    'site-block-column' => [
                      'padding-top' => 'p-t-12 p-t-10-mb',
                      'padding-bottom' => 'p-b-12 p-b-10-mb',
