...
final class apanelUiTree
{
    ...
    public static function execute(array $params = []): array
    {
        ...
        $session_open_ids_key   = $params['session_open_ids_key'] ?? 'apanel_node_ids';
        $session_active_id_key  = $params['session_active_id_key'] ?? 'apanel_active_node_id';
