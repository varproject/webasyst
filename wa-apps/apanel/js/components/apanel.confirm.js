/**
 * apanel.confirm.js — МОДУЛЬ: CONFIRM
 *
 * НАЗНАЧЕНИЕ
 ...
 *
 * ПУБЛИЧНЫЙ API
 * - apanel.confirm.init() — инициализация (регистрация обработчиков).
 *
 * ПРАВИЛА
 * - init() идемпотентный:
 ...
 * - apanel.helpers (для getCsrfToken).
 *
 * ПОДКЛЮЧЕНИЕ
...
; (function (apanel, window, document) {
    ...
    var confirmModule = apanel.confirm = apanel.confirm || {};
    var MODAL_ID = 'apanel-confirm-modal';
    ...
    function performPendingAction() {
        ...
        var csrfToken = (apanel.helpers && apanel.helpers.getCsrfToken)
