(function($) {
    ...
    $.fn.favorite = function(selector, options, ext) {
        ...
        const getIcon = function(el) {
            return el.find('[data-icon="star"]');
        };
        ...
        var initIcon = context.data('favoriteSettingsInitIcon')  ||
                function(el) {
                    ...
                    if (el.hasClass(prefix + '-loading')) {
                        ...
                        icon.addClass('text-yellow').removeClass('text-light-gray');
                    } else {
                        icon.removeClass('text-yellow').addClass('text-light-gray');;
                    }
                };
