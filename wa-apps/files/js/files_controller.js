    ...
    $.files.controller = $.extend($.files.controller || {}, {
        ...
        dispatch: function (hash) {
            ...
            return this.doDispatch({
                hash,
                beforeActionApply() {
                    $('#f-core').find('.f-core-content').toggleClass('box contentbox', $.files.controller.currentAction !== 'plugins')
                },
         ...
         * @param {Function=} options.beforeActionApply
         * @return {boolean|*}
         */
            ...
            if (hash) {
                ...
                if (hash[0]) {
                    ...
                    if ($.files.controller[actionName + 'Action']) {
                        ...
                        if (typeof options.beforeActionApply === "function") {
                            options.beforeActionApply();
                        }
