...
(function ($) {
    ...
    $.widget('wa.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            add: function (e, data) {
                ...
                step2xhr.done(function() {
                    var cnt = fileupload._files.children().length;
                    var h3 = $('.f-upload-step2 h3', dialog);
                    h3.find('.f-title').html(h3.data('tmpl').replace('%d', cnt));
            ...
            send: function (e, data) {
                ...
                if (data.context && data.dataType &&
                    ...
                    data.context.find('.progressbar-inner').css('width', '100%');
                }
            },
            ...
            // Callback for successful uploads:
                ...
                if (data.context) {
                    ...
                    if (n == that.filesCount) {
                        that.dialog.find('.js-close-dialog').trigger('click');
                    }
                }
            },
            ...
            progressall: function (e, data) {
                const progress = parseInt(data.loaded / data.total * 95, 10) + '%';
                $(this).find('.f-fileupload-progressbar').css('width', progress);
                $(".f-upload-filescount").html(progress);
            },
            ...
            stop: function (e) {
                ...
                $('.f-fileupload-progressbar', self).css({width: '100%'});
                ...
                if (!self.data('is_error') && !self.data('is_aborted')) {
                    ...
                    dialog.trigger('finishUploader', [result]);
                }
        ...
        _initButtonBarEventHandlers: function () {
            var fileupload = this;
            var fileUploadButtonBar = fileupload.element.find('.dialog-footer');
                    ...
                    if (!content.find('[name=solve]').length) {
                        $.get(
                            ...
                            function(html) {
                                ...
                                fileupload.dialog.data('dialog').resize();
                            }
                        );
                    } else {
                        filesList.find('.start').click();
