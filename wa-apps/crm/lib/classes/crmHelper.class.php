...
class crmHelper
{
    ...
    public static function removeEmoji($string)
    {
        ...
        $res = preg_replace($emoji_pattern, ':emoji:', $string);
        return empty($res) ? mb_convert_encoding($string, 'UTF-8') : $res;
    }
    ...
    public static function getVarsForContact($var_name = 'customer')
    {
        $vars = array(
            ...
            '$'.$var_name.'.birth_year'                      => sprintf(_w('Field %s of customer'), 'birth_year'),
